...
const FormAuth = () => {
  ...
  return (
    <form className="form-signin" onSubmit={onSubmit}>
      ...
      <input type="text" name="userName" id="userName" className="form-control" placeholder="Name" value={userName} onChange={onSetData} />
      <input type="password" name="pass" id="inputPassword" className="form-control" placeholder="Password" value={pass} onChange={onSetData} />
